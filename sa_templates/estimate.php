					...
					<div id="title">
						...
						<div class="current_status">
							...
							<?php elseif ( 'approved' === si_get_estimate_status() ) : ?>
								<span><?php esc_html_e( 'Approved', 'sprout-invoices' ) ?></span>
							<?php else : ?>
								<span><?php esc_html_e( 'Pending Approval', 'sprout-invoices' ) ?></span>
							<?php endif; ?>
						</div>
		...
		<section class="row" id="intro">
			<div class="inner">
				...
				<div class="column">
					...
					<div class="invoice_info"><?php printf( '<span class="info">%1$s</span> %2$s', __( 'Invoice #', 'sprout-invoices' ), si_get_estimate_id() ) ?></div>

					<?php if ( si_get_estimate_po_number() ) : ?>
						<div class="invoice_info"><?php printf( '<span class="info">%1$s</span> %2$s', __( 'PO #', 'sprout-invoices' ), si_get_estimate_po_number() ) ?></div>
					<?php endif ?>

					<div class="invoice_info"><?php printf( '<span class="info">%1$s</span> %2$s', __( 'Issued on', 'sprout-invoices' ), date_i18n( get_option( 'date_format' ), si_get_estimate_issue_date() ) ) ?></div>

					<div class="invoice_info"><?php printf( '<span class="info">%1$s</span> %2$s', __( 'Expires on', 'sprout-invoices' ), date_i18n( get_option( 'date_format' ), si_get_estimate_expiration_date() ) ) ?></div>

					<div id="total_due" class="invoice_info"><?php printf( '<span class="info">%1$s</span> <span class="total">%2$s</span>', __( 'Total Estimated', 'sprout-invoices' ), sa_get_formatted_money( si_get_estimate_total() ) ) ?></div>
